...
\code{\usetikzlibrary{arrows, arrows.meta, backgrounds}}

\code{\usetikzlibrary{calc, intersections, patterns}}

\code{\usetikzlibrary{shapes, shapes.geometric, through}}

\section{Sakktábla}
Szükséges csomag: \code{\usepackage{skak}}
