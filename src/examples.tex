...
\begin{tikzExample}
    \begin{tikzpicture}[scale = 0.7]
        ...
        \draw plot [smooth, tension = 1] coordinates {(0,10) (1,8) (0,4) (1,2)
                (0,0)}; %K12 
        \draw plot [smooth, tension = 1] coordinates {(1,8) (2,8) (2,5) (0,4)};
        %K13
        \draw plot [smooth, tension = 1] coordinates {(2,8) (3,9) (6,10)
                (5,12)}; %K3
        \draw plot [smooth, tension = 1] coordinates {(6,10) (8,10) (7,8) (9,7)
                (10,10)}; %K4 
        \draw plot [smooth, tension = 1] coordinates {(3,9) (4,7) (7,8)};
        %K2 
        \draw plot [smooth, tension = 1] coordinates {(4,7) (3,5) (2,5)};
        %K14
        \draw plot [smooth, tension = 1] coordinates {(9,7) (8,4) (5,1) (3,5)};
        %K1
        \draw plot [smooth, tension = 1] coordinates {(5,1) (5,0) (1,2)};
        %K11
        \draw plot [smooth, tension = 1] coordinates {(5,0) (6,-1) (5,-2)};
        %K10
        \draw plot [smooth, tension = 1] coordinates {(6,-1) (8,0) (9,2) (10,4)
                (8,4)}; %K9
        \draw plot [smooth, tension = 1] coordinates {(10,0) (10,1) (8,0)};
        %K8
        \draw plot [smooth, tension = 1] coordinates {(10,4) (10,7) (11,5)
                (12,5)}; %K5
        \draw plot [smooth, tension = 1] coordinates {(11,5) (11,3) (9,2)};
        %K6 és K7
        \draw (0,8) node {$A$};
        \draw (3,10.5) node {$B$};
        \draw (1.3,6.3) node {$C$};
...
\begin{tikzExample}
    \begin{tikzpicture}[line cap=round,line join=round,>=triangle
        ...
        \draw [line width=0.4pt,domain=-7.44:9.29]
        plot(\x,{(-5.75--8.58*\x)/-5});
        \draw [line width=0.4pt,domain=-7.44:9.29]
        plot(\x,{(-21.74-8.58*\x)/-1});
        \draw [line width=1.6pt,dash pattern=on 3pt off 3pt] (4.66,1.8)--
        (0.9,-0.39);
        \draw [line width=1.6pt,dash pattern=on 3pt off 3pt] (-2.23,2.61)--
        (4.66,1.8);
        \draw [line width=1.6pt,dash pattern=on 3pt off 3pt] (4.66,1.8)--
        (4.66,-4);
        \draw [line width=1.6pt,dash pattern=on 5pt off
            3pt,color=red,domain=-7.44:9.29] plot(\x,{(-1.47--3*\x)/-3.13});
        \begin{small}
...
\begin{tikzExample}
    ...
    \begin{tikzpicture}[line cap=round,line join=round,>=triangle
        ...
        \draw[line width=1.5pt,dash pattern=on 1pt off 2pt on 5pt off
            4pt,color=red, smooth,samples=100,domain=-3.8859126567579696:9.331288233648893]
        plot(\x,{cos(((\x))*180/pi)});
...
\begin{tikzExample}
    ...
    \begin{tikzpicture}[scale=2, line cap=round]
        ...
        (-1,-1)--(0,-\sqtwo)--(1,-1)--(\sqtwo,0)--(1,1)--(0,\sqtwo)--(-1,1)--(-\sqtwo,0)--cycle;
        \fill[white]
        (-1,-1)--(0,-2+\sqtwo)--(1,-1)--(2-\sqtwo,0)--(1,1)--(0,2-\sqtwo)--(-1,1)--(-2+\sqtwo,0)--cycle;
        ...
        \draw[line width=1.5, dashed]
        (0,2-\sqtwo)--(2-\sqtwo,0)--(0,\sqtwo-2)--(\sqtwo-2,0)--cycle;
...
\begin{tikzExample}
    ...
    \begin{tikzpicture}[yscale=1.732,scale=0.7]
        ...
        \filldraw[red, fill opacity=0.4]
        (-1,-1)--(1,-1)--(2,0)--(1,1)--(-1,1)--(-2,0)--cycle;
        ...
        \foreach \x in {2,...,\y}
            {
                ...
                \draw[blue,line width=2,->] (2*\x-2.3,2*\y-0.3) --
                (2*\x-2.7,2*\y-0.7);
                \draw[blue,line width=2,->] (2*\x-1.7,2*\y-0.3) --
                (2*\x-1.3,2*\y-0.7);
                \draw[blue,line width=2,->] (2*\x-2.7,2*\y-1.3) --
                (2*\x-2.3,2*\y-1.7);
            }
        \foreach \y in {3,4,5}
        \foreach \x in {3,...,\y}
        \draw[blue,line width=2,->] (2*\x-3.3,2*\y-1.3) --
        (2*\x-3.7,2*\y-1.7);
    \end{tikzpicture}
\end{tikzExample}
