...
A \code{\usepackage{tikzpicture}} kell a library implementálásához A \code{\begin{tikzpicture}} és \code{\end{tikzpicture}} parancsok közé kell helyezni a rajzolandó ábrát. A \tikzname\ úgy működik, mint egy rajztábla. Egyesével kell az objektumokat rárajzolni, esetenként egy ciklusban többet is lehet egyszerre (lásd lejjebb). \textbf{Minden parancsot egy  ;-vel kell lezárni.}
