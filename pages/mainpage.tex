...
% {\printchaptername A \chapternamenum B \printchapternum}
% {\printchapternum.\@\chapternamenum C \printchaptername}
% {}{}
%\makeatother
...
\HTMLFirstPageTop{\includegraphics[height=50px]{./logo.png}}
\HTMLPageTop{\includegraphics[height=50px]{./logo.png}}
\HTMLPageBottom{©Bertalan Dávid, Alexy Marcell - A Gondolkodás Öröme Alapítvány}
...
\begin{document}
	...
	\include{tikz_fejezet}
	
	%\appendix
	\include{hogyan_mukodik}
